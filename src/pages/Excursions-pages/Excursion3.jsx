...
const Excursion3 = () => {
    ...
    const highlights = t('excursion3.highlights', { returnObjects: true });
    return (
        <>
            ...
            <section id="excursion-single" className="py-4">
                <div className="container">
                    <div className="title-wrap">
                        ...
                        <h2 className="lg-title">{t('excursion3.title')}</h2>
                    </div>
                        ...
                        <article className="excursion-single-content">
                            <p>
                                <img
                                    ...
                                    src="/images/Excursions/Imlil & Toubkal.webp"
                                    alt={t('excursion3.alt')}
                                />
                            </p>
                            <div className="info-card">
                                <div className="info-meta">
                                    <span className="badge"><i className="fa fa-road" aria-hidden="true"></i> {t('excursion.common.distance', { value: t('excursion3.distanceValue') })}</span>
                                    <span className="badge"><i className="fa fa-clock-o" aria-hidden="true"></i> {t('excursion.common.duration', { value: t('excursion3.durationLabel') })}</span>
                                </div>
                                ...
                                <p className="text">
                                    <Trans i18nKey="excursion3.overview" components={{ strong: <strong /> }} />
                                </p>
                            </div>
                        </article>
            ...
            <section className="py-4x">
                <div className="container">
                    <BookingForm excursionId={3} excursionTitle={t('excursion3.bookingTitle')} />
                </div>
            </section>
        </>
    );
