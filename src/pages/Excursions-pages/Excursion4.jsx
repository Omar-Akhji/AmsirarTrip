...
const Excursion4 = () => {
    ...
    const highlights = t('excursion4.highlights', { returnObjects: true });
    return (
        <>
            ...
            <section id="excursion-single" className="py-4">
                <div className="container">
                    <div className="title-wrap">
                        ...
                        <h2 className="lg-title">{t('excursion4.title')}</h2>
                    </div>
                        ...
                        <article className="excursion-single-content">
                            <p>
                                <img
                                    ...
                                    src="/images/Excursions/Ourika Valley.webp"
                                    alt={t('excursion4.alt')}
                                />
                            </p>
                            <div className="info-card">
                                <div className="info-meta">
                                    <span className="badge"><i className="fa fa-road" aria-hidden="true"></i> {t('excursion.common.distance', { value: t('excursion4.distanceValue') })}</span>
                                    <span className="badge"><i className="fa fa-clock-o" aria-hidden="true"></i> {t('excursion.common.duration', { value: t('excursion4.durationLabel') })}</span>
                                </div>
                                ...
                                <p className="text">
                                    <Trans i18nKey="excursion4.overview" components={{ strong: <strong /> }} />
                                </p>
                            </div>
                        </article>
            ...
            <section className="py-4x">
                <div className="container">
                    <BookingForm excursionId={4} excursionTitle={t('excursion4.bookingTitle')} />
                </div>
            </section>
        </>
    );
