...
const Excursion6 = () => {
    ...
    const highlights = t('excursion6.highlights', { returnObjects: true });
    return (
        <>
            ...
            <section id="excursion-single" className="py-4">
                <div className="container">
                    <div className="title-wrap">
                        ...
                        <h2 className="lg-title">{t('excursion6.title')}</h2>
                    </div>
                        ...
                        <article className="excursion-single-content">
                            <p>
                                <img
                                    ...
                                    src="/images/Excursions/Hot Air Balloon Ride.webp"
                                    alt={t('excursion6.alt')}
                                />
                            </p>
                            <div className="info-card">
                                <div className="info-meta">
                                    <span className="badge"><i className="fa fa-road" aria-hidden="true"></i> {t('excursion.common.distance', { value: t('excursion6.distanceValue') })}</span>
                                    <span className="badge"><i className="fa fa-clock-o" aria-hidden="true"></i> {t('excursion.common.duration', { value: t('excursion6.durationLabel') })}</span>
                                </div>
                                ...
                                <p className="text">
                                    <Trans i18nKey="excursion6.overview" components={{ strong: <strong /> }} />
                                </p>
                            </div>
                        </article>
            ...
            <section className="py-4x">
                <div className="container">
                    <BookingForm excursionId={6} excursionTitle={t('excursion6.bookingTitle')} />
                </div>
            </section>
        </>
    );
