...
const Excursion5 = () => {
    ...
    const highlights = t('excursion5.highlights', { returnObjects: true });
    return (
        <>
            ...
            <section id="excursion-single" className="py-4">
                <div className="container">
                    <div className="title-wrap">
                        ...
                        <h2 className="lg-title">{t('excursion5.title')}</h2>
                    </div>
                        ...
                        <article className="excursion-single-content">
                            <p>
                                <img
                                    ...
                                    src="/images/Excursions/Agafay.webp"
                                    alt={t('excursion5.alt')}
                                />
                            </p>
                            <div className="info-card">
                                <div className="info-meta">
                                    <span className="badge"><i className="fa fa-road" aria-hidden="true"></i> {t('excursion.common.distance', { value: t('excursion5.distanceValue') })}</span>
                                    <span className="badge"><i className="fa fa-clock-o" aria-hidden="true"></i> {t('excursion.common.duration', { value: t('excursion5.durationLabel') })}</span>
                                </div>
                                ...
                                <p className="text">
                                    <Trans i18nKey="excursion5.overview" components={{ strong: <strong /> }} />
                                </p>
                            </div>
                        </article>
            ...
            <section className="py-4x">
                <div className="container">
                    <BookingForm excursionId={5} excursionTitle={t('excursion5.bookingTitle')} />
                </div>
            </section>
        </>
    );
