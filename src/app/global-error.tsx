...
export default function GlobalError({
  ...
  return (
    <html lang="en">
      <body className="flex flex-col items-center justify-center bg-slate-50 font-sans min-block-screen">
        <h2 className="mbe-4 text-2xl font-bold text-slate-800">
          A Critical Error Occurred
        </h2>
        <p className="mbe-6 text-center text-slate-600 max-inline-md">
