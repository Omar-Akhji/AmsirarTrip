...
export default function FooterTailwind() {
  return (
    <footer
      className="relative z-10 mbs-0 box-border overflow-hidden border-t-4 border-orange bg-zinc-950 pbs-6 text-start leading-[1.6] text-white shadow-[0_-8px_32px_rgba(0,0,0,0.5)] ring-1 ring-white/5 inline-full sm:pbs-8"
      role="contentinfo"
    >
      ...
      <div className="pointer-events-none absolute inset-0 overflow-hidden">
        <div className="absolute -end-16 -top-16 size-72 rounded-full bg-orange/5 blur-3xl" />
        <div className="absolute -start-20 -bottom-20 size-87.5 rounded-full bg-orange/3 blur-3xl" />
